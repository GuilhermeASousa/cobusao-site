...
export const CITIES_CONFIG = {
  rio: {
    ...
    macroRegion: 'Sudeste',
    fullName: 'Rio de Janeiro (Municipal & Intermunicipal)',
    flag: '🏖️',
    center: [-22.9068, -43.1729],
    zoom: 12,
    agencyName: 'SMTR & DETRO-RJ',
    fare: 'R$ 5,00',
  ...
  rio_intermunicipal: {
    ...
    stateFullName: 'Rio de Janeiro',
    macroRegion: 'Sudeste',
    fullName: 'Rio de Janeiro (DETRO - Intermunicipal)',
    flag: '🚌',
  ...
  sp: {
    ...
    macroRegion: 'Sudeste',
    fullName: 'São Paulo (SPTrans, EMTU & Região)',
    flag: '🏙️',
    center: [-23.5505, -46.6333],
    zoom: 12,
    agencyName: 'SPTrans & EMTU-SP',
    fare: 'R$ 5,30',
